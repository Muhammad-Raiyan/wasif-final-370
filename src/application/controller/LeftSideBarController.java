...
public class LeftSideBarController {
    ...
    protected static  String REGISTRATION_FORM_PATH = "/resource/view/RegistrationForm.fxml";
    protected static  String SIGN_IN_FORM_PATH = "/resource/view/SignInForm.fxml";
